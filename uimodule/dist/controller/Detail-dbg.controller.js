sap.ui.define(
  ...
  function (Controller, History, MessageBox) {
    ...
    return Controller.extend("com.santiago.exampleui5.controller.Detail", {
      onInit: function () {
        var oRouter = sap.ui.core.UIComponent.getRouterFor(this);

        oRouter
          .getRoute("Detail")
          .attachMatched(this.onRouteMatchedDetail, this);
        oRouter
          .getRoute("DetailID")
          .attachMatched(this.onRouteMatchedDetail, this);
      },
      ...
      onRouteMatchedDetail: function (oEvent) {
        ...
        if (!CIF) {
          ...
          this.getView().byId("Tomador").setValue("");
        } else {
          this.getView().byId("Tomador").setValue("Canon");
        }
      },
