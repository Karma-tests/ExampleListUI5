sap.ui.define(
  ...
  function (
    ...
    return Controller.extend("com.santiago.exampleui5.controller.List", {
      formatter: formatter,
      ...
      getUser: function (oEvent) {
        ...
        if (!this._oPopover) {
          Fragment.load({
            id: "popoverPerfilCon",
            name: "com.santiago.exampleui5.view.fragments.popUpPerfil",
            controller: this,
          }).then(
            function (oPopover) {
      ...
      showMenu: function (oEvent) {
        ...
        if (!this._oPopover) {
          Fragment.load({
            id: "popoverPerfilCon",
            name: "com.santiago.exampleui5.view.fragments.popUpNav",
            controller: this,
          }).then(
            function (oPopover) {
              this._oPopover = oPopover;
      ...
      Enviar: function () {
        MessageBox.confirm(
          "¿Está seguro de enviar todos los documentos seleccionados?"
        );
      },
